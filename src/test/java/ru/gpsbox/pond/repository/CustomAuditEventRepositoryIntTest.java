...
import ru.gpsbox.pond.JhipstnewApp;
...
import static ru.gpsbox.pond.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
@SpringBootTest(classes = JhipstnewApp.class)
